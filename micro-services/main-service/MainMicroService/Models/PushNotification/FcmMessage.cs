...
namespace Main.Models.PushNotification
{
    public class FcmMessage<T>
    {
        ...
        ///     The array must contain at least 1 and at most 1000 registration tokens. To send a message to a single device, use
        ///     the to parameter.
        /// </summary>
        ...
        ///     This is intended to avoid sending too many of the same messages when the device comes back online or becomes
        ///     active.
        /// </summary>
        public string CollapseKey { get; set; }

        /// <summary>
        ///     Sets the priority of the message. Valid values are "normal" and "high." On iOS, these correspond to APNs priorities
        ///     5 and 10.
        ///     By default, notification messages are sent with high priority, and data messages are sent with normal priority.
        ///     Normal priority optimizes the client app's battery consumption and should be used unless immediate delivery is
        ///     required. For messages with normal priority, the app may receive the message with unspecified delay.
        ...
        /// <summary>
        ///     Fcm notification
        ///     This parameter specifies the predefined, user-visible key-value pairs of the notification payload. See Notification
        ///     payload support for detail.
        ///     For more information about notification message and data message options, see Message types.
        ///     If a notification payload is provided, or the content_available option is set to true for a message to an iOS
        ///     device, the message is sent through APNs, otherwise it is sent through the FCM connection server
        /// </summary>
