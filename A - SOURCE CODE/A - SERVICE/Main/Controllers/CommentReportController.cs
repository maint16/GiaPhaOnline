...
namespace Main.Controllers
{
    ...
    public class CommentReportController : ApiBaseController
    {
        ...
        //        if (from != null)
        //            commentReports = RelationalDbService.SearchNumericProperty(commentReports,
        ...
        //    if (sort != null)
        //        commentReports = RelationalDbService.Sort(commentReports, sort.Direction, sort.Property);
        //    else
        //        commentReports = RelationalDbService.Sort(commentReports, SortDirection.Decending,
        ...
        //    result.Records = await RelationalDbService.Paginate(commentReports, condition.Pagination).ToListAsync();
        //    ;
