...
namespace Main.Controllers
{
    ...
    public class CommentController : ApiBaseController
    {
        ...
        public CommentController(IUnitOfWork unitOfWork, IMapper mapper, ITimeService timeService,
        ...
        //        comments =
        //            RelationalDbService.Sort(comments, condition.Sort.Direction,
        //                condition.Sort.Property);
        //    else
        //        comments = RelationalDbService.Sort(comments, SortDirection.Decending,
        //            CommentSort.CreatedTime);

        //    var result = new SearchResult<IList<Comment>>();
        //    result.Total = await comments.CountAsync();
        //    result.Records = await RelationalDbService.Paginate(comments, condition.Pagination).ToListAsync();
        ...
        //        if (from != null)
        //            comments = RelationalDbService.SearchNumericProperty(comments, x => x.CreatedTime,
        ...
        //        if (from != null)
        //            comments = RelationalDbService.SearchNumericProperty(comments, x => x.LastModifiedTime,
        //                from.Value, NumericComparision.GreaterEqual);
        //        if (to != null)
        //            comments = RelationalDbService.SearchNumericProperty(comments, x => x.LastModifiedTime,
        //                to.Value, NumericComparision.LowerEqual);
